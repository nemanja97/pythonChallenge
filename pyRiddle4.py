# Start URL = http://www.pythonchallenge.com/pc/def/equality.html
# We are looking for a lowercase letter surrounded by three upercase letters to it's side
...
# Splitting text into lines to avoid newlines problems
lines = text.splitlines()
letterString = ''

for i in range(1,len(lines)):
    workingText = lines[i]
    for i in range(3, len(workingText) - 3):
        if workingText[i - 3:i].isupper() == True and workingText[i].islower() == True and workingText[i + 1:i + 4].isupper() == True and\
           workingText[i-4].isupper() == False and workingText[i+4].isupper() == False:
            letterString += workingText[i]
print '\n',letterString

# End URL = http://www.pythonchallenge.com/pc/def/linkedlist.html